...
|---------|-------------|----------|
| [`@ryzome-ai/ryzome-core`](packages/ryzome-core) | Shared logic: API client, 15 tools, graph builder, layout | [![npm](https://img.shields.io/npm/v/@ryzome-ai/ryzome-core)](https://www.npmjs.com/package/@ryzome-ai/ryzome-core) |
...
`ryzome-core` contains the API client, 15 tools, graph builder, layout engine, and markdown formatter. The MCP server, OpenClaw plugin, and Hermes plugin all reuse that shared tool implementation.
